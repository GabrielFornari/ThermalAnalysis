...
#tifImg = my_tifread("D:/Flir E5x Data/Tiff (32 bit)/N14ZP7_SimpleTest_Crop/", 600)
...
pngImg = []
#pngImg.append(my_pngread("D:/Flir E5x Data/Images/N14ZP7_SimpleTest_2_Crop/", 20))
#pngImg.append(my_pngread("D:/Flir E5x Data/Images/N14ZP7_SimpleTest_2_Crop/", 70*9))
pngImg.append(my_pngread("D:/Flir E5x Data/Images/N14ZP7_SimpleTest_2_Crop/", 1350))
#pngImg.append(my_pngread("D:/Flir E5x Data/Images/N14ZP7_SimpleTest_2_Crop/", 320*9))
#pngImg.append(my_pngread("D:/Flir E5x Data/Images/N14ZP7_SimpleTest_2_Crop/", 335*9))

#pngImg.append(my_pngread("D:/Flir E5x Data/Images/N14ZP7_IoTest_Crop/", 1350))
#pngImg.append(my_pngread("D:/Flir E5x Data/Images/N14ZP7_MemTest_2_Crop/", 1350))
#pngImg.append(my_pngread("D:/Flir E5x Data/Images/N14ZP7_ProcTest_Crop/", 1350))
#pngImg.append(my_pngread("D:/Flir E5x Data/Images/N14ZP7_CPUError_Crop/", 1350))
#pngImg.append(my_pngread("D:/Flir E5x Data/Images/N14ZP7_MemError_Bios_Crop/", 1350))

for img in pngImg:
    plt.figure()
    plt.imshow(my_pngROICrop(img, selectedROI))

#my_imRect(tifImg, [[ROIIdx[0], ROIIdx[1], 2, 2]])
#plt.figure()
#plt.imshow(pngImg)
#my_pngROI(pngImg, selectedROI)
plt.show()
